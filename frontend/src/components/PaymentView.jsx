      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', gap: 10, margin: '15px 0' }}>
          <button
            ...
            style={{ flex: 1, padding: 15, background: method === 'phonepe' ? '#5f259f' : '#ccc', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer' }}
          >
            📱 PhonePe
          </button>
          <button
            ...
            style={{ flex: 1, padding: 15, background: method === 'googlepay' ? '#4285f4' : '#ccc', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer' }}
          >
            🌐 Google Pay
          </button>
        </div>
